...
import {
	CoOwnershipFormSheet,
	LoanFormSheet,
	LoanInsuranceFormSheet,
	PropertyDeleteSheet,
	PropertyEditSheet,
	PropertyInsuranceFormSheet,
	UtilityContractFormSheet,
} from '@/components'
import type {
	CoOwnershipFormData,
	InsuranceFormData,
...
interface PropertyDetailSheetsProps {
...
export function PropertyDetailSheets({
	property,
	members,
	loadingMembers,
	formatCurrency,
