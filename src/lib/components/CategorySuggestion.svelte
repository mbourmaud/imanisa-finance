	...
	async function createRule() {
		...
		try {
			...
			if (!response.ok) {
				...
				throw new Error(data.message || 'Erreur lors de la création de la règle');
			}
	...
	>
		{#if showSuccess}
			<div class="success-content">
				...
				<h2>Règle créée !</h2>
				<p>Les transactions similaires seront automatiquement catégorisées.</p>
			</div>
		{:else}
			<div class="modal-header">
				<h2 id="suggestion-title">Créer une règle ?</h2>
			...
			<div class="modal-body">
				<p class="suggestion-text">
					Voulez-vous catégoriser automatiquement les transactions similaires ?
				</p>
				...
				<div class="pattern-section">
					...
					<span id="pattern-hint" class="pattern-hint">
						Expression régulière (insensible à la casse). Utilisez | pour plusieurs mots.
					</span>
				</div>
